...
void seuillageTest() {
    ...
    ecrirePGM(seuillage(intensite(lirePGM("images/Embryos.512.pgm")), 70), "seuillage/Embryos.512.pgm");
...
void doubleSeuillageTest(){
    ...
    cout << "\tProposer des seuils pour Embryos.512.pgm et House.256.pgm" << endl;
  ecrirePGM(doubleSeuillage(lirePGM("images/Embryos.512.pgm"), seuillage(intensite(lirePGM("images/Embryos.512.pgm")), 10), 50), "seuillage_double/Embryos.512.pgm");
    ecrirePGM(doubleSeuillage(lirePGM("images/House.256.pgm"), seuillage(intensite(lirePGM("images/House.256.pgm")), 10), 50), "seuillage_double/House.256.pgm");
}
...
void doubleSeuillageIteratifTest() {
    ...
    ecrirePGM(doubleSeuillage(intensite(lirePGM("images/Willis.512.pgm")), 500, 50, 200), "seuillage_double/iteratif_WillisFort.512.pgm");
    
    cout << "\tProposer des seuils pour Billes.256.pgm, Embryos.512.pgm et House.256.pgm" << endl;
      ecrirePGM(doubleSeuillage(intensite(lirePGM("images/Willis.512.pgm")), 500, 10, 100), "seuillage_double/iteratif_WillisFaible.512.pgm");
    ecrirePGM(doubleSeuillage(intensite(lirePGM("images/Embryos.512.pgm")), 500, 40, 100), "seuillage_double/iteratif_Embryos.512.pgm");
    ecrirePGM(doubleSeuillage(intensite(lirePGM("images/House.256.pgm")), 500, 80, 105), "seuillage_double/iteratif_House.256.pgm");
     ecrirePGM(doubleSeuillage(intensite(lirePGM("images/Billes.256.pgm")), 500, 90, 110), "seuillage_double/iteratif_Billes.256.pgm");
}

int main(){
    // clang++ seuillage.o sobel.o seuillage-test.o pgm.o  -o seuillage-test
    renormaliseTest();
    seuillageTest();
    doubleSeuillageTest();
