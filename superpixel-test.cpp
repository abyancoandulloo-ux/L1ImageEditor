...
void superPixelTest() {
    ...
    ecrirePPM(superPixel(lirePPM("images/Baboon.512.ppm"), 1, 60, 15),  "superpixel/Baboon.512.ppm");
    ...
    ecrirePPM(superPixel(lirePPM("images/Embryos.512.ppm"), 2, 60, 15),  "superpixel/Embryos.512.ppm");
    ecrirePPM(superPixel(lirePPM("images/House.256.ppm"  ), 1, 100, 15),  "superpixel/House.256.ppm");
    ecrirePPM(superPixel(lirePPM("images/Willis.512.ppm"  ), 100, 60, 15),  "superpixel/Willislambda.512.ppm");
    ecrirePPM(superPixel(lirePPM("images/Willis.512.ppm"  ), 1, 100, 15),  "superpixel/Willismu.512.ppm");
